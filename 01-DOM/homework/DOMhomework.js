...
function buildToDos(toDos) {
  var arr = toDos.map(function (el, index) {
...
// arr = [<div class='toDoShell'> <span> todo.description </span> </div> , <div class='toDoShell'> <span> todo.description </span> </div>]
